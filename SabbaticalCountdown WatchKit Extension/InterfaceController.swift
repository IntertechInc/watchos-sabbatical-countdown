...
//  SabbaticalCountdown WatchKit Extension
//
//  Created by Chad Towle on 11/27/15.
...
class InterfaceController: WKInterfaceController {
    ...
    override func awakeWithContext(context: AnyObject?) {
        ...
        NSTimer.scheduledTimerWithTimeInterval(1.0, target: self, selector: Selector("startCountDown:"), userInfo: nil, repeats: true)
    }
